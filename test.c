...
{
    printf("\n\t\t\t\t\t\t\t1. View total sales\n");
    printf("\t\t\t\t\t\t\t2. Add new dish to menu\n");
    printf("\t\t\t\t\t\t\t3. Delete dish from menu\n");
    printf("\t\t\t\t\t\t\t4. Show menu\n");
    printf("\t\t\t\t\t\t\t5. Back To Menu \n\n");
    printf("\t\t\t\t\t\t\t   What do you want (enter 1-5)? --->");
}

void customermenu()
{
    printf("\n\t\t\t\t\t\t\t1. View the menu\n");
    printf("\t\t\t\t\t\t\t2. View your ordered\n");
    printf("\t\t\t\t\t\t\t3. Remove a dish from ordered\n");
    printf("\t\t\t\t\t\t\t4. Display your final bill\n");
    printf("\t\t\t\t\t\t\t5. Back To Menu \n\n");
    printf("\t\t\t\t\t\t\t   What do you want (enter 1-5)? --->");
}
...
{
    printf("\n                                 **************************************************************************\n");
    printf("                                                     WELCOME TO VIETNAMESE RESTAURANT \n");
    printf("                                 **************************************************************************\n\n\n");
    printf("\t\t\t\t\t\t\t1. ADMIN ROLE--> \n");
    printf("\t\t\t\t\t\t\t2. CUSTOMER ROLE--> \n");
    printf("\t\t\t\t\t\t\t3. Exit--> \n\n");
...
int main()
{
    heada = createadmin(heada,1,"Chicken Mushroom Soup",30);
    heada = createadmin(heada,2,"Beef Noodle",50);
    heada = createadmin(heada,3,"Sticky Rice Cake",150);
    heada = createadmin(heada,4,"Fried Rice",100);
    heada = createadmin(heada,5,"Spring Rolls",80);
